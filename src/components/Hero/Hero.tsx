  ...
  return (
      ...
      <div id={"hero"}
          ...
          <div className="flex flex-col">
              <h1 className={`lg:text-lg text-md text-white font-thin animate-fadeUp delay-0  ${jetbrains_mono.className}`}>Hi, my name is</h1>
              <h1 className={`lg:text-9xl text-7xl font-extrabold tracking-tighter text-secondary animate-fadeUp delay-200  `}>Tien
                  Le.</h1>
              <h1 className={`lg:text-7xl text-5xl font-bold tracking-tighter text-tertiary animate-fadeUp delay-400 `}>I
                  design and craft beautiful things for the web</h1>
              <h1 className="lg:text-2xl text-md text-white  animate-fadeUp delay-600 ">

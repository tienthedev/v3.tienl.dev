...
const Hero: React.FC = () => {
  return (
      <div
          className={`bg-primary h-screen w-screen flex flex-col justify-center items-center text-left -tracking-widest px-10 lg:px-56 ${jetbrains_mono.className} z-0`}>
          <div className="flex flex-col">
              <h1 className="text-lg text-white font-thin animate-fadeUp delay-0 hidden-initially">Hi, my name is</h1>
              ...
              <h1 className="text-lg text-white font-thin animate-fadeUp delay-600 hidden-initially">

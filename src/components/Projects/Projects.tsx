...
const projects: Project[] = [
    ...
    },
    {
        ...
        date: "June 2023",
        tags: ["TensorFlow", "Flask", "AWS"],
        img: "/assets/tdhotel.png",
        description: "Deployed a machine learning model for sentiment analysis using Flask and AWS.",
    },
];
...
const Projects: React.FC = () => {
    return (
        <div
            id="project"
            className={`h-screen flex flex-col justify-center items-center text-left px-10 lg:px-56 ${leagueSpartan.className} z-0`}
        >
            <div className="flex flex-col">
                <p className="pb-2 lg:text-6xl font-extrabold tracking-tighter text-md text-secondary animate-fadeUp delay-600">
                    Projects
                </p>
